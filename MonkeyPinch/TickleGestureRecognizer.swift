...
//  MonkeyPinch
//
//  Created by Kevin Pham on 9/11/14.
...
class TickleGestureRecognizer: UIGestureRecognizer {
    ...
    // 1 Gesture requirement constants.
    let requiredTickles = 2
    let distanceForTickleGesture : CGFloat = 25.0 // Specify as a CGFloat. If you do not, then it will be inferred as a Double, and cause difficulties when doing calculations with CGPoints later on.
    
    // 2 Possible tickle directions.
    enum Direction:Int {
    ...
    // 3 Tracked variables for gesture.
